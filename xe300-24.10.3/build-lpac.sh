#!/bin/bash
#
# GL-XE300 (OpenWrt 24.10.3) lpac build script
...
BUILD_DIR="${HOME}/.local/build/lpac-xe300-24.10.3"

# LPAC source directory
LPAC_SOURCE_DIR="${PROJECT_ROOT}/lpac"

# SDK information (reference for manual installation)
SDK_URL="https://downloads.openwrt.org/releases/${OPENWRT_VERSION}/targets/${OPENWRT_TARGET}/${OPENWRT_SUBTARGET}/openwrt-sdk-${OPENWRT_VERSION}-${OPENWRT_TARGET}-${OPENWRT_SUBTARGET}_gcc-13.3.0_musl.Linux-x86_64.tar.xz"
...
clean_all() {
    ...
    log_info "Note: SDK preserved (~/xe300-24.10.3-sdk/)"
}
