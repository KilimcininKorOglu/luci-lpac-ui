#!/bin/bash
#
# GL-XE300 (OpenWrt 24.10.3) quectel_lpad build script for
...
echo "║  Target: OpenWrt 24.10.3 / MIPS 24Kc                     ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
SDK_DIR="${HOME}/xe300-24.10.3-sdk/sdk"
OUTPUT_DIR="${SCRIPT_DIR}/output"
BUILD_DIR="${SCRIPT_DIR}/build"

# SDK information (reference for manual installation)
SDK_URL="https://downloads.openwrt.org/releases/${OPENWRT_VERSION}/targets/${OPENWRT_TARGET}/${OPENWRT_SUBTARGET}/openwrt-sdk-${OPENWRT_VERSION}-${OPENWRT_TARGET}-${OPENWRT_SUBTARGET}_gcc-13.3.0_musl.Linux-x86_64.tar.zst"
SDK_ARCHIVE="openwrt-sdk-${OPENWRT_VERSION}.tar.zst"
SDK_EXTRACTED="openwrt-sdk-${OPENWRT_VERSION}-${OPENWRT_TARGET}-${OPENWRT_SUBTARGET}_gcc-13.3.0_musl.Linux-x86_64"
...
setup_toolchain() {
    ...
    export PATH="${SDK_DIR}/staging_dir/toolchain-mips_24kc_gcc-13.3.0_musl/bin:$PATH"
...
compile() {
    ...
    local target_dir="${SDK_DIR}/staging_dir/target-mips_24kc_musl"
    local toolchain_dir="${SDK_DIR}/staging_dir/toolchain-mips_24kc_gcc-13.3.0_musl"
...
clean_all() {
    ...
    log_info "Not: SDK korundu (~/xe300-24.10.3-sdk/)"
}
